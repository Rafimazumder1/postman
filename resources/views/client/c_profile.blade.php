...
<body>
            ...
            <div class="dropdown dropdown-end">
                <label tabindex="0" class="btn btn-ghost btn-circle avatar">
                    <div class="w-30 rounded-full">
                        ...
                        <img alt="Tailwind CSS Navbar component" src="/img/postman.png" />
    ...
    <div class="card w-100 bg-base-100 shadow-xl" style="position: relative;">
        <figure style="position: relative; overflow: hidden;">
            <img class="h-96 w-full" src="/img/shop.png" alt="Shoes" />
            <button class="absolute top-0 left-0 text-1xl m-10 p-3 rounded-full bg-white">
                <i class="fa fa-camera mr-4">Change Cover</i>
            </button>
        </figure>
