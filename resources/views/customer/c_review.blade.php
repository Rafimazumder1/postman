...
<link rel="stylesheet" href="https://horizon-tailwind-react-corporate-git-main-horizon-ui.vercel.app/static/css/main.d7f96858.css" />
...
<body>
    ...
    <div class="lg:px-20 md:px-6 px-4 py-12">
        ...
        <div class="w-full lg:flex items-center  gap-6 mt-10">
            <div class="lg:w-1/3" >
                <div class="bg-white dark:bg-gray-800  border rounded-md border-gray-200 dark:border-gray-700  relative sm:p-10 p-6" style="border-radius:10px 60px ">
                    <div>
            ...
            <div class="lg:w-1/3 lg:mt-0 mt-16">
                <div class="bg-white dark:bg-gray-800  dark:bg-gray-800  border rounded-md border-gray-200 dark:border-gray-700  relative sm:p-10 p-6" style="border-radius:10px 60px">
                    <div>
                        <img src="https://tuk-cdn.s3.amazonaws.com/can-uploader/testimonials-4-svg1.svg" alt="commas" />
                    </div>
                    <p class="text-base leading-6 text-gray-600 dark:text-white  mt-4">When our designs need an expert opinion or approval, I know I can rely on your agency Thank you for all your help-I will be recommending you to everyone</p>
