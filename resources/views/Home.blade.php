                      ...
                      <body>
                          ...
                          <section class="section-padding earn-with-Postman">
                              ...
                              <div class="wrapper">
                                  ...
                                  <div class="slide b">Our default slide size is min-width: 100vh; That means 100% of
                                      the view height (i.e. a square). Using javascript, we calculate the width of the
                                      div based on the dimensions of the background image. This image is square.</div>
                                  <div class="slide c">
                      ...
                      <div class="container1">
                          <div class="row" style="margin-left:50px;margin-right:0px">
                              <div class="col-lg-6">
                                  ...
                                  <h3>have a car</h3>
                                  <p>
                                      Lorem ipsum dolor sit amet, conse ctetur adipi scing elit, sed do eiusmod tempor
                                      incididunt
                      ...
                      <div class='container'>
                        <h1 class='page-header text-center' style="background-color: black; height:50px; color:aliceblue; border-radius:10px"> Parcel Cost Calculator</h1>
                        <div class='jumbotron'>
                          <form>
                      ...
                      <div class="container_map" >
                        <div class="coverage be-animated in-view">
                            ...
                            {{-- <video id="background-video" autoplay loop muted poster="https://assets.codepen.io/6093409/river.jpg">
                                ...
                                <h3 style="animation: scaleAnimation 5s ease-in-out;">We are currently available in 64 districts.</h3>
                                <div class="row_map">
                                <div class="col-7">
                                    <div class="slide-nav-map-map">
                                        <select id="transportation-selector">
                                            <option value="surface" class="active">Surface</option>
                                ...
                                <div class="col-5">
                                    <a href="https://ecourier.com.bd/wp-content/uploads/map-01-1.svg">
                                        <img decoding="async" fetchpriority="high" class="alignnone wp-image-2898" role="img"
                                            src="https://ecourier.com.bd/wp-content/uploads/map-01-1.svg" alt="" width="600" height="900">
                                    </a>
                                </div>
                            </div>
                        </div>
